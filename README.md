...
RTA: Un Network Security Group es un firewall a nivel de red con un conjunto de reglas cuyo proposito es gestionar permitiendo o denegando el tráfico de red tanto de entrada como de salida a los recursos de Azure que tengamos desplegados.
